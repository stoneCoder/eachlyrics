...
@property(nonatomic, strong) NSString *mp3FileServerPath;
@property(nonatomic, strong) NSString *lrcFileServerPath;
@property(nonatomic, strong) NSString *mp3FileLocalPath;
@property(nonatomic, strong) NSString *lrcFileLocalPath;
